# Generated by Django 3.1.4 on 2021-01-04 13:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bdate', models.DateTimeField(auto_created=True, auto_now_add=True)),
        ...
        migrations.CreateModel(
            name='items',
            fields=[
                ('date', models.DateTimeField(auto_created=True, auto_now_add=True, verbose_name='Date Created')),
                ...
                ('min_price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.bids')),
            ],
        ),
        migrations.CreateModel(
            name='comments',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cdate', models.DateTimeField(auto_created=True, auto_now_add=True)),
                ('comment', models.TextField()),
                ('citem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.items')),
